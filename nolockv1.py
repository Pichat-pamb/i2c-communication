...
def led_loc(address, led_location, color_tagging):
    if led_location == 0:
        data_list1 = [0]  # led bytes data to sent
        if color_tagging == 0:
            datalist2 = [0, 0, 0]
        elif color_tagging == 1:
            data_list2 = [255, 0, 0]
    elif led_location == 1:
        data_list1 = [1]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
            data_list2 = [255, 127, 0]
    elif led_location == 2:
        data_list1 = [2]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
        ...
        data_list1 = [4]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
            data_list2 = [0, 0, 255
    elif led_location == 5:
        data_list1 = [5]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
            data_list2 = [75, 0, 130]
    elif led_location == 6:
        data_list1 = [6]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
            data_list2 = [148, 0, 211]
    elif led_location == 7:
        data_list1 = [7]  # led bytes data to sent
        if color_tagging == 0:
            data_list2 = [0, 0, 0]
        elif color_tagging == 1:
